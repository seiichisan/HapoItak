...
CONST_WRAP_SINGLE_QUOTATION_EVERY_LINE = "wrap_single_quotation_and_comma_every_line"
CONST_WRAP_SINGLE_QUOTATION_EVERY_WORD = "wrap_single_quotation_and_comma_every_word"
...
class HapoItakArrayTranslationCommand(sublime_plugin.TextCommand):
	def run(self, edit):
		self.list = [CONST_WRAP_DOUBLE_QUOTATION_EVERY_LINE,
						...
						CONST_WRAP_SINGLE_QUOTATION_EVERY_LINE, CONST_WRAP_SINGLE_QUOTATION_EVERY_WORD]
		...
		for region in selection_list:
			if not region.empty():
				...
				if tag_name == CONST_WRAP_DOUBLE_QUOTATION_EVERY_LINE:
					selection = string_util.wrap_double_quotation_every_line(selection, True)

				elif tag_name == CONST_WRAP_DOUBLE_QUOTATION_EVERY_WORD:
					selection = string_util.wrap_double_quotation_every_word(selection, True)
				...
				elif tag_name == CONST_WRAP_SINGLE_QUOTATION_EVERY_LINE:
					selection = string_util.wrap_double_quotation_every_line(selection, False)

				elif tag_name == CONST_WRAP_SINGLE_QUOTATION_EVERY_WORD:
					selection = string_util.wrap_double_quotation_every_word(selection, False)
